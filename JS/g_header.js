...
/*第三方用户登录相关地址*/var g_APIUTL_User = "/JYH/API_User.aspx";
/*接口ego地址*/var g_ego_api_url = "/Ajax/EgoHandler.ashx";
/*接口Method*/var g_APIMethod = "POST";
/*接口响应数据格式*/var g_APIResponseDataType = "json";

/*投注请求地址*/var g_tz_api_url = "/Ajax/rhHandler.ashx"

//========一元购新增加  开始========
/*前台、后台上传图片后前端访问文件服务器图片域名*/var g_const_pic_ym = "http://172.18.19.166:8002";
/*晒单详情默认头像*/var g_const_default_head = "/img/portrait.png";
/*微信中分享使用的一元夺宝的图片【正式地址修改】*/var g_const_share_pic = "http://dog.lacues.cn/img/share_ego.png";

/*首页分享*/
var g_const_share_index_title = "惠家有1元夺宝";
var g_const_share_index_desc = "1块钱也能买iphone6s？！挤啥挤~给我加个塞儿~";
var g_const_share_index_pic = "http://1.huijiayou.cn/img/40@2x.png";

/*商品详情分享*/
var g_const_share_productdetail_title = "惠家有1元夺宝";


/*订单详情分享*/
var g_const_share_orderdetail_title = "好人品，看这里！1元中大奖啦！";
var g_const_share_orderdetail_desc = "别说我没告诉你，在惠家有1元就能中大奖！";
var g_const_share_orderdetail_gourl = "http://1.huijiayou.cn/Goods/GoodsDetail.html";

/*晒单列表分享*/
var g_const_share_showorderlist_title = "1元夺宝是假的？带你揭晓真面目";
var g_const_share_showorderlist_desc = "生活不止有远方，还有惠家有1元夺宝的真实体验";

/*晒单详情分享*/
var g_const_share_showorderdetail_title = "万万没想到，人品还能这么用！";
var g_const_share_showorderdetail_desc = "心得";
...
function ShowMesaage(sMessage) {
    if ($("#messagePop").length > 0) {
        ...
        var html = '<div class="pop_tipWrap" style="display:none;" id="messagePop"><span class="pop_tip" id="message">' + sMessage + '</span></div>';
    ...
    if (u.Trim().length > 0) {
        switch (t) {
            ...
            case g_const_showmoreLinktype.ProductDetail:
                sreturn = "/Product_Detail.html?frd=yes&pid=" + u;
                break;
            case g_const_showmoreLinktype.ProductType:
                sreturn = "/Product_List.html?frd=yes&showtype=category&keyword=" + u;
            case g_const_showmoreLinktype.KeyWordSearch:
                sreturn = "/Product_List.html?frd=yes&keyword=" + encodeURIComponent(u);
                break;
