...
var g_pay_ment = {
	...
	YinLianPayWap: { Paygate: "624", PaygateType: "6", PaygateAccount: "624" },
...
var g_const_ego_orderStatus = {
    ...
    //领宝成功
    "GetSucc": "50",
    getText: function (status, paygate, paygatetype, hjyorderstatus, cashawardstatus) {
        switch (status) {
            ...
            case g_const_ego_orderStatus.GetSucc://领宝成功
                ...
                if (hjyorderstatus == g_const_orderStatus.DFH) {
                    return "待发奖";
                }
                else if (hjyorderstatus == g_const_orderStatus.DSH) {
                    return "待收奖";
                }
                else {
                    return "领奖成功";
...
var g_const_PageURL = {
    ...
    /*最新揭晓*/
    "AwardList": "/Goods/AwardList.html",
    /*常见问题*/
    ...
    /*我的账户信息*/
    "MyAccountInfo": "/Account/PersonalInfo.html",
    /*我的昵称*/
    "MyNickName": "/Account/MyNickName.html",
    /*我的订单*/
    "MyOrder_List": "/Account/MyOrders.html",
    /*我的中奖列表*/
    "MyAwards": "/Account/MyAwards.html",
    /*我的订单--订单详情*/
    ...
    /*晒单发布页*/
    "ShowOrder_Add": "/Account/ShowOrder_add.html",
    /*晒单详情页*/
    "ShowOrder_Detail": "/Account/ShowOrder_Detail.html",
    /*晒单列表[全部用户]*/
    "ShowOrder_List": "/Account/ShowOrder_List.html",
    /*优惠卷列表*/
    "CouponList": "/Account/CouponList.html",
    /*选择优惠卷列表*/
    "SelectCoupon": "/Account/SelectCoupon.html",
    /*充值页面*/
    "Recharge": "/Account/Recharge.html",
    /*我的余额*/
    "MyBalance": "/Account/MyBalance.html",
...
var g_const_API_Message = {
    ...
    "106003": "请您核对身份证信息！",
    "106004": "昵称提交成功！",
    "106005": "昵称为2-10个字符，可中英文、数字、“-”、“_”组成",
    "106006": "您还没有修改昵称哦！",
    "106007": "设置个性昵称",
    "106008": "包含敏感词：",
...
var g_const_OrderConfirmRefer = ["goodsdetail", "index", "login", "personal", "mybalance"];
