...
function gotourlaa(id) {
    if (id == "qgg") {
        ...
        window.location.href = g_const_PageURL.Index + "?frd=yes&t=" + Math.random();

    }
    else if (id == "sc") {
        //window.location.href = g_const_PageURL.MyCollection;
        PageUrlConfig.SetUrl();
        window.location.href = g_const_PageURL.MyCollection + "?frd=yes&t=" + Math.random();
...
function btncaozuo(btnname, order_code, order_money) {
    ...
    switch (btnname) {
        ...
        case "ckwl"://查看物流
            ...
            window.location.href = g_const_PageURL.MyOrder_List_ckwl + "?frd=yes&order_code=" + order_code + "&t=" + Math.random();
        ...
        case "qfk"://去付款
            ...
            if (IsInWeiXin.check()) {
                var wxUrl = g_const_PageURL.MyOrder_pay + "?frd=yes&order_code=" + order_code + "&order_money=" + order_money + "&t=" + Math.random() + "&showwxpaytitle=1";
                WxInfo.GetPayID(wxUrl);
            }
            else {
                window.location.href = g_const_PageURL.MyOrder_pay + "?frd=yes&order_code=" + order_code + "&order_money=" + order_money + "&t=" + Math.random();
            }
            break;
        case "pjsd"://评价晒单
            PageUrlConfig.SetUrl();
            window.location.href = g_const_PageURL.ReviewRelease + "?frd=yes&order_code=" + order_code + "&s=l&t=" + Math.random();
            break;
...
function GoToOrderDetail(btnname, order_code, order_money) {
    if (btnname == "") {
        ...
        window.location.href = g_const_PageURL.MyOrder_detail + "?frd=yes&order_code=" + order_code + "&paytype=" + $("#sel_order_status").val() + "&t=" + Math.random();
