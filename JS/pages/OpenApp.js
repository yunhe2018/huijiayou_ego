        ...
        if (refresh == 1) {
            ...
            if (browser.versions.ios || browser.versions.iPhone || browser.versions.iPad) {
                if (ua.indexOf("MicroMessenger") > 0 || ua.match(/MicroMessenger/i) == "micromessenger") {
                    ...
                    hasApp("huijiayou://huijiayou.com?frd=yes" + openUrl);
                }
            } else if (browser.versions.android) {
                if (ua.indexOf("MicroMessenger") > 0 || ua.match(/MicroMessenger/i) == "micromessenger") {
                    //window.location = "http://a.app.qq.com/o/simple.jsp?pkgname=com.jiayou.qianheshengyun.app&g_f=991850"
                    ...
                    hasApp("huijiayou://huijiayou.com?frd=yes&" + openUrl + "#Intent;scheme=http;package=com.jiayou.qianheshengyun.app;end");
                } else {
                    hasApp("huijiayou://huijiayou.com?frd=yes&" + openUrl + "#Intent;scheme=http;package=com.jiayou.qianheshengyun.app;end");
                }
            } else {
